App.Backup = function () {
    const __NAMESPACE__ = 'App.Backup';
    ...
    let select_collection = function(d) {
        ...
        let div = m('div', { class: 'backup' });
        // let result = m('div', { class: 'backup_result', id: result_id() });
    ...
    let select_collection_embed = function (d) {
        ...
        let div = m('div', { class: 'backup' });
        let button = m('button', { 'data-modal': embed_modal_id()}, 'Backup meta-data');
