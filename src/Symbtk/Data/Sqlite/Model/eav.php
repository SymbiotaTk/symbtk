<?php
namespace Symbiotatk\Symbtk\Data\Sqlite\Model\Eav;
...
const CREATE_EAV_INDEX = "CREATE INDEX idx_:table_eav ON :table (entity, attribute, value);";

const INSERT_UUID_NEW = "INSERT INTO :uuid_table (timestamp) VALUES (DATETIME('now', 'localtime'))";
